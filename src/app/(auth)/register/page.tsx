...
// You can create a dedicated component for this Google icon button
const GoogleIcon = () => (
    ...
    <>
      <div className="text-center mb-6">
        ...
        <p className="text-slate-500">
          Start your journey with TravelMate.lk
        </p>
      </div>
      <form className="space-y-4">
        <div>
          <label htmlFor="name" className="text-sm font-medium text-slate-700">Name</label>
          <Input id="name" type="text" placeholder="Asitha Udara" required className="mt-1" />
        </div>
        <div>
